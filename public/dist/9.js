webpackJsonp([9],Array(369).concat([
/* 369 */
...
var _EditSectionForm = __webpack_require__(870);

var _EditSectionForm2 = _interopRequireDefault(_EditSectionForm);

var _style = __webpack_require__(873);
...
function SectionPage(_ref) {
  ...
  var order = match.params.order;
  var WrappedForm = _form2.default.create()(_EditSectionForm2.default);
  var section = list.find(function (section) {
    return section.name === sectionName;
  });
  var right = _react2.default.createElement(WrappedForm, { section: section, order: order });
...
var _styles = __webpack_require__(871);
...
var editSectionForm = function (_Component) {
  ...
  function editSectionForm() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = editSectionForm.__proto__ || (0, _getPrototypeOf2.default)(editSectionForm)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (e) {
      ...
      if (section.value.order) {
        section.value.push((0, _assign2.default)({}, values, { order: order || section.value.length }));
      } else {
        section.value.push((0, _assign2.default)({}, values, { order: section.value.length }));
      }
      console.info('submit_section', section);
  ...
  (0, _createClass3.default)(editSectionForm, [{
    ...
    value: function render() {
      ...
      // console.info('section##', section, order);
      var fields = section && section.fields;
      var item = void 0;
      if (order && section && section.value && section.value[order]) {
        item = section.value[order];
      }
